...
Route::group(['prefix'=>'admin','middleware'=>'authorLogin'],function(){	

	Route::get('dashboard','PagesController@dashboard');
	Route::get('error/unauthorized','PagesController@unauthorized');
	Route::group(['prefix'=>'theloai','middleware'=>'modLogin'], function(){
	...
	Route::group(['prefix'=>'loaitin','middleware'=>'modLogin'], function(){
